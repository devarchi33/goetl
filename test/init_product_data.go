...
func setProductData() {
	...
	sql = `
		...
		('pangpang', 'Q3AFAFDU6S21', '男女同款拖鞋', 40, '', 79, 0, 1, '2019-07-25 00:38:00', '2019-07-25 00:38:00', null),('pangpang', 'SPWH936D54', '条纹衬衫', 2, '', 259, 0, 1, '2019-07-25 00:38:00', '2019-07-25 00:38:00', null);
	`
	if _, err := session.Exec(sql); err != nil {
		log.Printf("setProductData error: %v", err.Error())
		log.Println()
...
func setSkuData() {
	...
	sql = `
		...
		VALUES 
			...
			(7, 'SPWH936D5430075', '男女同款拖鞋, (00)生产代表颜色, 260MM', '', '2019-07-25 00:39:13', '2019-07-25 00:39:13', null, 1),
			(7, 'SPWH936D5430080', '男女同款拖鞋, (00)生产代表颜色, 270MM', '', '2019-07-25 00:39:13', '2019-07-25 00:39:13', null, 1);
	`
	if _, err := session.Exec(sql); err != nil {
		log.Printf("setSkuData error: %v", err.Error())
		log.Println()
